...
import com.imran.freeearn.utils.TinyDB;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.nav_group:
                        ...
                        break;
                    case R.id.nav_dev:
                        loadUrl(Constants .SR_Creator_DEV_URL);
                        break;
                }
                return true;
            }
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (data != null) {
                                ...
                                app_controller.dataStore(spin_limit, daily_task_limit, spin_control,  spin_waitingTime);
